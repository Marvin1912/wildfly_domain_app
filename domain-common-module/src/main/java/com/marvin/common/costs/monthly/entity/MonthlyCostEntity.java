package com.marvin.common.costs.monthly.entity;
...
@NamedQueries({
        @NamedQuery(
                name = MonthlyCostEntity.FIND_MONTHLY_COST_BY_DATE,
                query = "SELECT m FROM MonthlyCostEntity m WHERE m.costDate = :date"
        ),
        @NamedQuery(
                name = MonthlyCostEntity.GET_MONTHLY_COSTS,
...
public class MonthlyCostEntity extends BasicEntity {
    ...
    public static final String FIND_MONTHLY_COST_BY_DATE = "findMonthlyCostByDate";
